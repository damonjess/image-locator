...
android {
    ...
    testOptions {
        // Let unit tests call android.util.Log etc. without throwing "Stub!"
...
dependencies {
    ...
    // Real org.json for unit tests: android.jar only ships compile-time stubs
    // whose methods return null/0, which breaks any test that parses JSON.
